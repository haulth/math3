...
from tkinter import *
import tkinter
from math3 import main1
from math3_2 import main2
...
lb1=Label(root,text="Chọn Dạng Toán:",font=("Arial", 20), fg="red")
lb1.pack()
...
def openNewWindow2():
    ...
    button = Button(root2, text="Tính toán", command=tinh )
    button.grid(row=2, column=0, padx=10)
btn1=Button(root,text="Toán 1 Phép Tính",command=openNewWindow1)
btn1.pack()

btn2=Button(root,text="Toán 2 Phép Tính",command=openNewWindow2)
btn2.pack()
